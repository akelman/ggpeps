...
class TestMinimizerZ2(unittest.TestCase):
    ...
    def test_derivative_mag_energy_exact_1_layer(self):
        ...
        sys = system.Z2System2D_G2C_F2C(system_cfg)
        gauge_fixing = False
        ...
        for ind in range(3):
            with self.subTest(ind=ind):
                ...
                sys_left = system.Z2System2D_G2C_F2C(system_cfg_left)
                sys_right = system.Z2System2D_G2C_F2C(system_cfg_right)
    ...
    def test_derivative_mag_energy_y(self):
        ...
        gauge_fixing = False
        mc_mgr = EvaluatorManager(system.Z2System2D_G2C_F2C, system_cfg, mc_config, 0, gauge_fixing=False)
