...
class TestZ2C2SystemMethods(unittest.TestCase):
    ...
    def test_grad_el_energy_2_layer(self):
        ...
        lat_2x2 = lattice.Lattice2D(2, 2)
        system_cfg = system.Z2System2D2CConfig(lat_2x2, 1.0, None, None, None, None, num_pg_layer=1, num_fermionic_layer=0)
        system_cfg.paramvec = paramvec
        system_z2_2_2 = system.Z2System2D(system_cfg)
        deriv_ana = system_z2_2_2.el_energy_op_grad_vec
        symbolvec = system_z2_2_2.symbolvec
        ...
        for layerind in range(nlayer):
            for ind in range(len(symbolvec)):
                with self.subTest(symbol=symbolvec[ind], layerind=layerind):
                    ...
                    system_cfg_left = system.Z2System2D2CConfig(lat_2x2, 1.0, None, None, None, None, num_pg_layer=1, num_fermionic_layer=0)
                    system_cfg_right = system.Z2System2D2CConfig(lat_2x2, 1.0, None, None, None, None, num_pg_layer=1, num_fermionic_layer=0)
