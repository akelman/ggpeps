...
class TestZ2SystemMethods(unittest.TestCase):
    ...
    def test_tmat_deriv_symb(self):
        ...
        tmat_left = system_z2_2_2_left.tmat
        tmat_right = system_z2_2_2_right.tmat
    ...
    def test_gamma_dirac_deriv_symb(self):
        ...
        symbvec = system_z2_2_2.symbolvec
        #Derivative wrt y
        deriv_ana = system_z2_2_2.compute_gamma_dirac_deriv(symbvec[1])
        gamma_left = system_z2_2_2_left.gamma_dirac
        gamma_right = system_z2_2_2_right.gamma_dirac
    ...
    def test_derivative_y(self):
        ...
        cfg = system.Z2System2DConfig(paramvec, lat, 0, 0, 0)
        system_z2_2_2 = system.Z2System2D(cfg)
        res = system_z2_2_2.compute_gamma_maj_deriv(system_z2_2_2.symbolvec[1])
        self.assertTrue(np.allclose(ref, res))
    ...
    def test_derivative_z(self):
        ...
        cfg = system.Z2System2DConfig(paramvec, lat, 0, 0, 0)
        system_z2_2_2 = system.Z2System2D(cfg)
        res = system_z2_2_2.compute_gamma_maj_deriv(system_z2_2_2.symbolvec[2])
    ...
    def test_derivative_t(self):
        ...
        cfg = system.Z2System2DConfig(paramvec, lat, 0, 0, 0)
        system_z2_2_2 = system.Z2System2D(cfg)
        res = system_z2_2_2.compute_gamma_maj_deriv(system_z2_2_2.symbolvec[0])
        compare_array_elementwise(self,ref,res)
    ...
    def test_gamma_maj_deriv_symb_y(self):
        ...
        symbvec = system_z2_2_2.symbolvec
        #Derivative wrt y
        deriv_ana = system_z2_2_2.compute_gamma_maj_deriv(symbvec[1])
    ...
    def test_derivative_t_numeric(self):
        ...
        lat = lattice.Lattice2D(2, 2)
        paramvec = [0.17, 0.35, 0.56]
        paramvec_left = [0.17-eps, 0.35, 0.56]
        paramvec_right = [0.17+eps, 0.35, 0.56]
        ...
        deriv_ana=system_z2_2_2.compute_gamma_maj_deriv(system_z2_2_2.symbolvec[0])
        gamma_left=system_z2_2_2_left.gamma_maj
        gamma_right=system_z2_2_2_right.gamma_maj
        deriv_num=(gamma_right-gamma_left)/(2*eps)
    ...
    def test_derivative_y_numeric_pure_gauge(self):
        ...
        lat = lattice.Lattice2D(2, 2)
        paramvec = [0.17, 0.35, 0.56]
        paramvec_left = [0.17, 0.35-eps, 0.56]
        paramvec_right = [0.17, 0.35+eps, 0.56]
        ...
        deriv_ana=system_z2_2_2.compute_gamma_maj_deriv(system_z2_2_2.symbolvec[1])
        gamma_left=system_z2_2_2_left.gamma_maj
        gamma_right=system_z2_2_2_right.gamma_maj
        deriv_num=(gamma_right-gamma_left)/(2*eps)
    ...
    def test_derivative_z_numeric_pure_gauge(self):
        ...
        lat = lattice.Lattice2D(2, 2)
        paramvec = [0.17, 0.35, 0.56]
        paramvec_left = [0.17, 0.35, 0.56-eps]
        paramvec_right = [0.17, 0.35, 0.56+eps]
        ...
        deriv_ana=system_z2_2_2.compute_gamma_maj_deriv(system_z2_2_2.symbolvec[2])
        gamma_left=system_z2_2_2_left.gamma_maj
        gamma_right=system_z2_2_2_right.gamma_maj
        deriv_num=(gamma_right-gamma_left)/(2*eps)
    ...
    def test_grad_el_energy(self):
        ...
        system_cfg = system.Z2System2DConfig(paramvec, lat_2x2, 1.0, None, None)
        system_z2_2_2 = system.Z2System2D(system_cfg)
        deriv_ana = system_z2_2_2.el_energy_op_grad
        for ind in range(3):
            with self.subTest(ind=ind):
                paramvec_left=np.copy(paramvec)
                paramvec_right=np.copy(paramvec)
...
class TestMinimizerZ2(unittest.TestCase):
    ...
    def test_derivative_mag_energy_y(self):
        eps = 1e-4
        paramvec = [0.1, 0.3, 1.4]
        paramvec_left = [0.1, 0.3-eps, 1.4]
        paramvec_right = [0.1, 0.3+eps, 1.4]
        lat_2x2 = lattice.Lattice2D(2, 2)
        system_cfg = system.Z2System2DConfig(paramvec, lat_2x2, 1.0, None,
                                             None)
        system_cfg_left = system.Z2System2DConfig(paramvec_left, lat_2x2, 1.0,
        ...
        minimizer.last_result=minimizer.mc_mgr.simulate()
        mc_left.simulate()
        mc_right.simulate()
