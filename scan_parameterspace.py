...
def main(args):
    ...
    for paramvec in tqdm(paramproduct):
        ...
        if args.exact:
            ...
            fname_summary = "summary_mc_L_{:02d}-{:02d}_gel_{:.3f}_gm_{:.3f}_gmag_{:.3f}_t_{}_y_{}_z_{}.pkl".format(
                system_cfg.lattice.nx,system_cfg.lattice.ny, system_cfg.g_el, system_cfg.g_gm, system_cfg.g_mag, paramvec[0], paramvec[1], paramvec[2])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--nstep",
                        default=10,
                        type=int,
                        help="Number of steps in the parameter")
