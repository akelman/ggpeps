...
- The formula for $\Gamma_\text{out}$ mistakenly used $-\Gamma_\text{in}(\mathcal{G})$ instead of $+\Gamma_\text{in}(\mathcal{G})$ based on a misinterpretation of conventions in (Bravyi, 2005). This change was merged into the main branch in commit `d190675`.